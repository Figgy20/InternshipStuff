 ...
 * @author m303user
 */
public class BPICreditCardServicesDivision extends CreditCardRegulations implements BIRMessages, BIRTaxPayment{
    ...
    public double computeVat(double amountPurchased) {
        return amountPurchased + (amountPurchased*VAT_AMOUNT);
    }
    
    public void VATMessageAnnouncement(){
        System.out.println("\n"+ANNOUNCEMENT_ON_VAT);
